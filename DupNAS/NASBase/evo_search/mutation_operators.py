...
class MutationOperator:
    def __init__(self, global_settings: Settings, arch_manager, num_blocks, **kwargs):
        ...
        self.mutate_prob_per_block = global_settings.DupNAS['STAGE2_SETTINGS']['MUT_PROB_PER_BLOCK']

        # for mutate_adaptive operator
        self.mutate_prob_block_exploration = global_settings.DupNAS['STAGE2_SETTINGS']['MUT_PROB_PER_BLOCK_EXPLORATION']
        self.mutate_prob_block_exploitation = global_settings.DupNAS['STAGE2_SETTINGS']['MUT_PROB_PER_BLOCK_EXPLOITATION']
        self.best_stable_generations = global_settings.DupNAS['STAGE2_SETTINGS']['BEST_STABLE_GENERATIONS']
